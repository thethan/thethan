...
@section('content')
    <div class="container-fluid">
        <div class="row page-title-row">
            <div class="col-md-12">
                <h3>Works <small>&raquo; Edit Work</small></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ route('admin.works.update', $id)}}" role="form"  method="POST" class="form-horizontal">
        ...
        <div class="modal-dialogue">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('admin.works.destroy', $id) }}" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
