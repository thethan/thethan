...
@section('content')
    <div class="container-fluid">
        {{--Top bar --}}
        <div class="row tage-title-row">
            <div class="col-md-6">
                <h3 class="pull-left">Uploads &nbsp; &nbsp;</h3>
                <div class="pull-left">
                    <ul class="breadcrumb">
                        @foreach($breadcrumbs as $path => $disp)
                            <li><a href="/admin/upload?folder={{$path}}">
                                    {{$disp}}
                                </a>
                            </li>
                        @endforeach
            ...
            <div class="col-md-6 text-right">
                <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#modal-create-folder">
                ...
                <table id="uploads-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach($subfolders as $path => $name)
                            <tr>
                                <td>
                                    <a href="/admin/upload?folder={{ $path }}"><i class="fa fa-folder fa-large"></i>
                                        {{ $name }}
                                    </a>
                                </td>
                                <td>Folder</td>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $file['webPath'] }}">
                                        ...
                                        @else
                                            <i class="fa fa-file-o fa-lg fa-fw">
                                            </i>
                                        @endif
                                        {{ $file['name'] }}
                                    </a>
                                ...
                                <td>
                                    <button class="btn btn-xs btn-danger" onclick="delete_file('{{$file['name']}}')">
                                        <i class="fa fa-times-circle fa-lg"></i> Delete
                                    </button>
                                    @if( is_image($file['mimeType']))
